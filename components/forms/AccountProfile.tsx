...
export default function AccountProfile({ user, btnTitle }: Props) {
    ...
    async function onSubmit(values: any) {
        ...
        // UPDATE YOUR PROFILE!!
        console.log("userId: ",user.id , values.username , values.name , values.bio , "Image: ",user?.image , pathname)
        await updateUser(user.id , values.username , values.name , values.bio , user?.image , pathname);
